...
#     ## Setup Lock-in for repeated measurements, external trigger
#     ## Setup Counter for n number of measurements with adjusted gate time, external trigger
#     ## Trigger measurement
#     ## Get data from each
#     ## Write out 4 columns: set f, x, y, beat f
